...
<%-- <th style="background-color:#1a78a5;"><font style="size:20px;" color="white";><center>Active Devices</center></font></th> --%>
<th style="background-color:#1a78a5;"><font style="size:20px;" color="white";><center>Sold Devices</center></font></th>
<%-- <th style="background-color:#1a78a5;"><font style="size:20px;" color="white";><center>Available Devices</center></font></th>  --%>
<th style="background-color:#1a78a5;"><font style="size:20px;" color="white";><center>T P Generated</center></font></th> 
</tr>
</thead>
<tbody>
...
<%--        <td style="background-color:white;"><font style="size:20px;" color="black"><center><b>{{x.pollingDevices}}</b></center></font></td> --%>
    <td style="background-color:white;"><font style="size:20px;" color="black"><center><b>{{x.sold}}</b></center></font></td>
<%--        <td style="background-color:white;"><font style="size:20px;" color="black"><center><b>{{x.availabledevices}}</b></center></font></td> --%>
       <td style="background-color:white;cursor:pointer;"  ng-click="gettripdetails(x.companyName);"data-toggle="modal" data-target="#mydeviceModal1"><font style="size:20px;" color="black"><center><span class="label label-success"><b>{{x.tripcount}}</b></span></center></font></td>
  </tr>
  <tr>
...
<%--       <td style="background-color:#9dabb5;"><font style="size:20px;" color="black"><center><b>{{totactivedevices}}</b></center></font></td> --%>
<td style="background-color:#9dabb5;"><font style="size:20px;" color="black"><center><b>{{solddevices}}</b></center></font></td>
...
<!-- 			</div>/.col -->
			...
			<div class="col-md-8" id="showgraph">
				<div class="panel panel-primary">
					<div class="panel-heading dark-overlay" id="dealerlabel"><i class="fa fa-pie-chart" style="color:white"></i><font color="white">CompanyWise Installed Devices</font></div>
					<div class="panel-body">

...
//	    });
  ...
  <div class="dd collapse in" hidden>
	<div>
		<button id="slider"  class="btn btn-default btn-xs btn-xs122" style="background-color:#34495e;float:left;color:white;display:none;"><span class="glyphicon glyphicon-align-justify" style="color:white;cursor:pointer;display:none;"></span></button>

		<div id="dislide" style="height:400px;width:300px;overflow:scroll;" >
		   <br>
				<table>
	 				<tr ng-repeat="x in MarkerArrayList">
  ...
  <div class="cd collapse in" hidden>
    ...
    <center><div class="btn-xs123" id="slide" hidden><span class="glyphicon glyphicon-chevron-down" style="color:white;cursor:pointer;display:none;"></span></div></center>
 </div>
 
 <div class="gd collapse in">
 <div class="btn-xs125" style="height:26px;display:none;" id="geoslide"><center><span style="color:white;cursor:pointer;display:none;display:none;"><label><font color="white"> Draw </font></label></span></center></div>
...
//# sourceURL=bebug.js
      ...
      app.controller('mapCtrl', function($scope, $http, $compile, $filter) {
    	  ...
    	  try{
    		 ...
    		 // alert(vehicleno+"2 "+fromtime+" "+totime);
//     		  alert('http://209.190.15.26/orsacwebservice/rest/CallService/gethistorytrip?vehicleno='+ vehicleno
...
// 	    		  if(type=='Running'){
// 	    			  createRunningMarkers($scope.MarkerArrayList)
// 	    		  }else if(type=='Hault'){
// 	    			  createHaultMarkers($scope.MarkerArrayList)
// 	    		  }else if(type=='All'){
// 	    			  createAllMarkers($scope.MarkerArrayList)
// 	    		  }else{
// 	    			  createStopMarkers($scope.MarkerArrayList)
// 	    		  }

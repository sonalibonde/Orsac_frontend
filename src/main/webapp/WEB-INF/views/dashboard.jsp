...
<!-- 								<span class="badge badge-grey">Legends</span> -->
				...
				<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
							...
							<ul class="dropdown-menu dropdown-navbar navbar-pink">
										...
										<li  style="background: #C0C0C0">
											<a href="">
														<img  title="Igntion Off" src="<c:url value="/resources/imagenew/greenbulb.png"/>">
														<font>Active Vehicles</font>
											</a>
										</li>

										<li style="background: #C0C0C0">
											<a href="">
														<img  title="GPS Connect" src="<c:url value="/resources/imagenew/redbulb.png"/>">
														<font>Inactive Vehicles</font>
											</a>
										</li>
...
<div class="row">
<fieldset style="border: 1px groove blue; height:130px; padding: 0 1.4em 1.4em 1.4em; margin: 0 0 1.5em 0; -webkit-box-shadow: 0px 0px 0px 0px #000; box-shadow: 0px 0px 0px 0px #000; margin-top: -10px;">
<legend style=" border-bottom: none; width: inherit;"><font size="5">Active Status</font></legend>
	...
	<a href="" title="Ignition On" style="text-decoration: none">
				<div class="panel panel-primary">
					...
					<a >	<img  title="Active Vehicles" ng-click="getsorted('ignnumberon')"  src="<c:url value="/resources/imagenew/greenbulb.png"/>"></a>

					</div>
			<div  class="" style="background-color: #1E0833;text-align: center"><a data-placement='bottom'  href=''><font color="white">{{active}}</font></a></div>
			...
			<div class="col-md-2"  style="width:85px;">
				...
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;height:50px ;">
					<a >	<img   title="inactive Vehicles" ng-click="getsorted('ignnumberoff')" src="<c:url value="/resources/imagenew/redbulb.png"/>"></a>
		
<!-- 					<a >View </a> -->
					</div>
			<div  class="" style="background-color: #1E0833;text-align: center"><a data-placement='bottom'  href=''><font color="white">{{inactive}}</font></a></div>

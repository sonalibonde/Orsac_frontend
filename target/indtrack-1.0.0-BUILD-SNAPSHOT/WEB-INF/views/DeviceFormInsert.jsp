...
<!--          <input type="button" ng-click = "uploadexcel()" value="upload"/>  -->
  ...
  <br>
   <div  style="text-align:right;"><font color="red">*Note: &nbsp; Excel Format Should be: &nbsp; SR No., Deviceid, IMEINO, Sim Mobile No, Sim No, VehicleNO</font><b style="color:Red;font-weight:normal;"></div>

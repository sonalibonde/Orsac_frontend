								...
								<div class="widget-box" id="rolemain">
									<div
										...
										<h5 class="widget-title">
											<font color="white">Daily Performance Report Movement Basis-Total Time Spend On Movement</font>
										</h5>
...
<div class="col-md-12">
	<div>
		<div class="panel panel-primary">
					<div class="panel-heading dark-overlay" id="dealerlabel"><i class="fa fa-bar-chart" style="color:white"></i><font>Top 10 Travelling Ambys – Movement Basis</font></div>
...
<%-- 														<col width="50%"> --%>
													...
													<tr id="gridheader">
													 ...
													 <th><font color="white">Top 10 Travelling Ambys – Movement Basis</font></th>
...
<div >
		<div class="panel panel-primary">
					<div class="panel-heading dark-overlay" id="dealerlabel"><i class="fa fa-bar-chart" style="color:white"></i><font>Top 10 Less Travelling Ambys – Movement Basis</font></div>
					<div class="panel-body">
...
<!-- 													 <th><font color="white">Top 10 Star Performing Ambys-Movement Basis</font></th> -->
													 <th><font color="white">Top 10 Less Travelling Ambys – Movement Basis</font></th>
													</tr>
													</thead>

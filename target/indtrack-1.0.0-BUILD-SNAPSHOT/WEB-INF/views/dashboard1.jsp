...
<div class="row">
	<div class="col-sm-12 ">
		<div class="infobox " style="width: 90px; height:60px;background-color: rgb(250,154,6);">
			<div class="infobox-icon">
			<img  title="total vehicles" src="<c:url value="/resources/images/busimage.png"/>">
		<font color="blue">{{totald}}</font>
			</div>

		</div>
		<div class="vspace-4-sm"></div>
		<div class="infobox" style="width:90px;height:60px;background-color: rgb(0,192,239)">
			<div class="infobox-icon">
		...
		<div class="vspace-4-sm"></div>
		<div class="infobox" style="width:90px;height:60px;background-color: rgb(245,105,84)">
			<div class="infobox-icon">
		...
		<div class="vspace-4-sm"></div>
		<div class="infobox " style="width: 90px;height:60px;background-color: rgb(0,166,90)">
			<div class="infobox-icon">
				<!-- 												<i class="ace-icon fa fa-twitter"></i> -->
...
<!-- 								<span class="badge badge-grey">Legends</span> -->
				...
				<ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
							...
							<ul class="dropdown-menu dropdown-navbar navbar-pink">
										...
										<li style="background-color: rgb(0,192,239)">
											<a href="">
										...
										<li style="background-color: rgb(245,105,84)">
											<a href="">
														<img  title="Ignition Off" src="<c:url value="/resources/images/IGINOff.png"/>">
...
<img title="Halt Count" src="<c:url value="/resources/images/hand.png"/>">	
									...
									<li style="background-color: rgb(0,166,90)">
											<a href="">
<img  title="Running Count" src="<c:url value="/resources/images/run.png"/>"height="32px" width="32px">
...
<!-- 												<select ng-init="somethingHere = options[0]" ng-model="somethingHere" ng-options="option.name for option in options"></select> -->
									<table class="table table-bordered " id="livesumm">
										<thead class="thin-border-bottom" style="height:34px">
											<tr id="gridheader">
												<th class="hidden-480" ng-click="sort('Serial No')"><font color="white">Sr.No.</font>
										...
										<tbody>
											<tr dir-paginate="user in users |orderBy:sortKey:reverse|filter:query|itemsPerPage:pagesint">
												...
												<td><a href=""  type="submit" id="showmap"  ng-click="showmapdiv1(user);graphhide();"> <span class="glyphicon glyphicon-map-marker"></span></a></td>
											</tr>
										</tbody>
									</table>
...
<img src="<c:url value="/resources/assets/images/back.png" />" height="20px" width="20px">
</a>

								...
								<div class="widget-box" id="rolemain">
									<div
										...
										<h5 class="widget-title">
											<font color="white">Mine Wise Truck Movement report</font>
										</h5>
...
<div class="row">
    ...
    <div ng-if="roleid!=1012" class="form-group col-xs-4 col-md-2">
                								...
                								<table   class=" table-bordered" border="2"  width="100%" cellspacing="0" id="overspeedtable"  hidden>
													...
													<thead>
														<tr id="gridheader">
															...
															<th><font color="white">Rout Deviation Count</font></th>

...
<!-- 															<td><font>{{comp.subdealername}}</font></td> -->
															...
															<td ng-if='comp.status=="Approved"'><font><button style="background-color: green;color: white; width:90px">{{comp.status}}</button></font></td>
															<td ng-if='comp.status=="Pending"'><font><button ng-click="getdet(comp);" data-toggle="modal" data-target="#myModal" style="background-color: #e07b53;color: white; width:90px">{{comp.status}}</button></font></td>
															<td ng-if='comp.status=="Approved"'><font><button ng-click="disapprove(comp);" style="background-color: red;color: white; width:90px">Unauthorize</button></font></td>

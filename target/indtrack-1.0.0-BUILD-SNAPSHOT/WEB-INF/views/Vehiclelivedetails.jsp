...
<legend style=" border-bottom: none; width: inherit;"><font size="5">Vehicle  Status</font></legend>
	...
	<a href="" title="Total vehicles" style="text-decoration: none">
				...
				<a  href="#/Vehiclelivedetails" ><img  title="Total vehicles" ng-click="getsorted('all')" src="<c:url value="/resources/images/busimage.png"/>"></a>
						</div>
...
<!-- 			<div  class="" style="background-color: #1E0833;text-align: center"><a data-placement='bottom'  href=''><font color="white">5222</font></a></div> -->
			...
			<div class="col-md-1 " style="width:85px;">
			<a href="#/Vehiclelivedetails" title="Halt Count" style="text-decoration: none">
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
...
<!-- 					<a >View </a> -->
			...
			<div class="col-md-1"  style="width:85px;">
				<a href="#/Vehiclelivedetails" title="Running Count" style="text-decoration: none">
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
			...
			<div class="col-md-1" style="width:85px;">
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
					<a href="#/Vehiclelivedetails">	<img   title="Stop Count" ng-click="getsorted('stop')" src="<c:url value="/resources/imagenew/stop.png"/>"></a>
			...
			<div class="col-md-1" style="width:85px;">
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
					<a href="#/Vehiclelivedetails">	<img   title="Not Working Count" ng-click="getsorted('stop')" src="<c:url value="/resources/imagenew/notworking.png"/>"></a>
...
<!-- 			</div> -->
			...
			<a href="" title="Overspeed Count" style="text-decoration: none">
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0;text-align:center;">
					<a href="#/Vehiclelivedetails">	<img   title="Overspeed Count" ng-click="getsorted('overspeed')" src="<c:url value="/resources/imagenew/overspeed.png"/>"></a>
...
<legend style=" border-bottom: none; width: inherit;"><font size="5">GPS Status</font></legend>
	...
	<div class="row" style="margin-top: -11px;">
			...
			<div class="col-md-4"  style="width:85px;">
				...
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
					<a href="#/Vehiclelivedetails">	<img   title="GPS Connect" ng-click="getsorted('gpson')" src="<c:url value="/resources/imagenew/GPSOn.png"/>"></a>
...
<!-- 					<a >View </a> -->
			...
			<a href="" title="GPS Disconnect" style="text-decoration: none">
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
				<a href="#/Vehiclelivedetails">	<img  title="GPS Disconnect" ng-click="getsorted('gpsoff')" src="<c:url value="/resources/imagenew/gpsoff.png"/>"></a>
...
<legend style=" border-bottom: none; width: inherit;"><font size="5">Ignition Status</font></legend>
	...
	<a href="" title="Ignition On" style="text-decoration: none">
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
					<a href="#/Vehiclelivedetails">	<img  title="Ignition On" ng-click="getsorted('ignnumberon')"  src="<c:url value="/resources/imagenew/IGINIOn.png"/>"></a>
			...
			<div class="col-md-2"  style="width:85px;">
				...
				<div class="panel panel-primary">
					<div class="panel-body"  style="background: #C0C0C0 ;text-align:center;">
					<a href="#/Vehiclelivedetails">	<img   title="Ignition Off" ng-click="getsorted('ignnumberoff')" src="<c:url value="/resources/imagenew/IGINOff.png"/>"></a>
...
<div class="panel-body">
<div text-align="right"><a data-toggle="tab" href="#/CustomerMap"><font size=20px>Live Map For All</font> </div>
						</a>
...
<td><input class="form-control" ng-model="query[queryBy]" /></td>
 ...
 <td> <select id="livevehiclesumspeedlimit"  style="width:100px;" class="form-control" ng-model="limit">
     														 <option value="20" >20</option>
     														 <option value="25" >25</option>
     														 <option value="30">30</option>
     														 <option value="35" >35</option>

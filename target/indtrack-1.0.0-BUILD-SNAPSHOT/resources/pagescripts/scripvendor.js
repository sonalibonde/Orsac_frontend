					...
					.success(function(data, status, headers, config) {
						...
						FusionCharts.ready(function() {
						    var revenueChart = new FusionCharts({
						        ...
						        dataSource: {
						            "chart": {
						                "caption": "Vehicle wise total Trips",
...
//							alert(data);
							...
							$scope.totdevices=0,$scope.totpolling=0,$scope.totnonpolling=0,$scope.totinstalled=0,$scope.available=0,$scope.tottripcount=0;
...
//						        ]);
						        ...
						        try{
							    	 var data1 = new google.visualization.DataTable();
								      ...
								      data1.addColumn('number', 'No.of Trips');
								      for(var m = 0;m<data.length;m++){
								    	   data1.addRows([
									        [String(data[m].companyName), Number(data[m].tripcount)]
									      ]);
